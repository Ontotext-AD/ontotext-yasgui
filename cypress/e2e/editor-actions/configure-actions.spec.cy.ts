...
describe('Configure editor actions', () => {
    ...
    it('Should see all custom actions by default in particular order', () => {
        ...
        YasqeSteps.getActionButtonTooltip(3).should('have.attr', 'data-tooltip', 'Explain query with LLM model');
        YasqeSteps.getActionButtonTooltip(4).should('have.attr', 'data-tooltip', 'Include inferred data in results: ON');
        YasqeSteps.getActionButtonTooltip(5).should('have.attr', 'data-tooltip', 'Expand results over owl:sameAs: ON');
    });
